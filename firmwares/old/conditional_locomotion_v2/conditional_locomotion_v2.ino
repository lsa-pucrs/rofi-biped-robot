...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
   ...
   ////////////// STAND
     if(currentAction == &standAction){
       Serial.println(" STAND ");
       if(distance>30)currentAction = &walkAction;
       else{ 
         currentAction->Update();
        //delay(500); // FORÇA O BUG
       }   
   }
 
   /////////////// WALK
    else if(currentAction == &walkAction){  
      Serial.println(" WALK ");
      if(distance<10)currentAction = &standAction; 
      else if(distance>10&&distance<20){
        currentAction = &rightTurnAction;
        currentAction->setPlaybackSpeed(0.30);
      } 
      else currentAction->Update();
    }  
   ////////////// RIGHT
    else if(currentAction == &rightTurnAction){
       Serial.println(" RIGHT");
       if(distance>30){
         //currentAction = &lookDownAction;
         currentAction = &walkAction;
         currentAction->setPlaybackSpeed(0.57);
       }
       else currentAction->Update(); 
    }  
   ////////////// LOOK
    //if(currentAction == &lookDownAction){
    //  currentAction = &standAction;
      //if(distance>15)currentAction = &standAction;
      //else currentAction->Update(); 
    //}  
  }
  else currentAction->Update();
